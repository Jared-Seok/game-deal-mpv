...
const SaleDealCard = ({ deal, className = "" })=>{
    ...
    const getReviewText = (meta)=>{
        ...
        return `${meta.positive_review_percent}% - ${meta.review_summary} (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatPrice"])(meta.total_reviews)}개)`;
    };
    return(// 🚨 [수정 2] 최상위 div에 className을 적용하여 DealCard로부터 받은 스타일을 사용합니다.
    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function DealCard({ deal, className = "" }) {
    ...
    const isFreeGame = deal.deal_type === "Free" || deal.sale_price === 0 && deal.deal_type !== "GamePass" || deal.epic_meta?.is_free_to_keep === true; // <- epic_meta로 변경
    if (isFreeGame) {
    ...
    const isGamePass = deal.deal_type === "GamePass" || deal.platform.includes("Xbox") || deal.xbox_meta !== undefined; // <- xbox_meta로 변경
    if (isGamePass) {
