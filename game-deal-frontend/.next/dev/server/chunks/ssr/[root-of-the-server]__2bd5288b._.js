        ...
        const fetchData = async ()=>{
            ...
            try {
                ...
                if (category === "free") {
                    ...
                    targetDeals = allDeals.filter((d)=>(d.sale_price === 0 || d.epicMeta?.is_free_to_keep) && !d.platform.includes("Xbox"));
                } else if (category === "sale") {
                    // 할인: 정가 > 판매가
                    targetDeals = allDeals.filter((d)=>d.regular_price > d.sale_price && d.sale_price > 0);
                } else if (category === "sub") {
                    // 구독: Xbox (또는 추후 PS Plus 등)
                    targetDeals = allDeals.filter((d)=>d.platform.includes("Xbox") || d.deal_type === "GamePass");
                }
