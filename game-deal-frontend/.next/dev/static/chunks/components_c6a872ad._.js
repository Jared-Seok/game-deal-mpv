...
function DealCard(t0) {
    ...
    if ($[0] !== "ede2096971a011d5856576839a2202a16ac53b95934a4cf19a0d57f20949e4f3") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ede2096971a011d5856576839a2202a16ac53b95934a4cf19a0d57f20949e4f3";
    }
    const { deal, className: t1 } = t0;
    const className = t1 === undefined ? "" : t1;
...
//# sourceMappingURL=components_c6a872ad._.js.map