...
function DealCard(t0) {
    ...
    if ($[0] !== "c2675d363fe8a9f56ba93a5904c2c432e0632cadc9059eafa3ee52e403841aec") {
        for(let $i = 0; $i < 38; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c2675d363fe8a9f56ba93a5904c2c432e0632cadc9059eafa3ee52e403841aec";
    }
    const { deal } = t0;
    const isFree = deal.deal_type === "Free";
    const t1 = deal.url;
    const t2 = `px-3 py-1 text-xs font-bold rounded-full ${isFree ? "bg-blue-100 text-blue-800" : "bg-green-100 text-green-800"}`;
    let t3;
    if ($[1] !== deal.platform || $[2] !== t2) {
    ...
    let t4;
    if ($[4] !== isFree) {
        t4 = isFree && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t7;
    if ($[11] !== deal.end_date) {
        t7 = deal.end_date && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "text-sm text-gray-500 mb-4",
            children: [
                "종료일: ",
                new Date(deal.end_date).toLocaleDateString("ko-KR")
            ]
        }, void 0, true, {
            fileName: "[project]/components/DealCard.tsx",
            lineNumber: 58,
    ...
    let t9;
    if ($[17] !== deal.regular_price) {
        t9 = deal.regular_price.toLocaleString();
        $[17] = deal.regular_price;
        $[18] = t9;
    } else {
        t9 = $[18];
    }
    ...
    let t11;
    if ($[21] !== deal.sale_price || $[22] !== isFree) {
        t11 = isFree ? "\uBB34\uB8CC" : `₩${deal.sale_price.toLocaleString()}`;
        $[21] = deal.sale_price;
        $[22] = isFree;
        $[23] = t11;
    } else {
    ...
    if ($[30] !== t13) {
        t15 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-gray-50 p-4 border-t border-gray-100 flex justify-between items-center",
            children: [
                t13,
                t14
            ]
    ...
    if ($[32] !== t15 || $[33] !== t8) {
        t16 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100 h-full flex flex-col",
            children: [
                t8,
                t15
            ]
...
;
;
function DealsPage(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(10);
    if ($[0] !== "a654552153808b1b5d68c2460f16f3934f7ff39f58c0be1a7654388d0dfb5206") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a654552153808b1b5d68c2460f16f3934f7ff39f58c0be1a7654388d0dfb5206";
    }
    const { initialDeals } = t0;
    const [searchTerm, setSearchTerm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    let t1;
    if ($[1] !== initialDeals || $[2] !== searchTerm) {
        let t2;
        if ($[4] !== searchTerm) {
            t2 = ({
                "DealsPage[initialDeals.filter()]": (deal)=>deal.title.toLowerCase().includes(searchTerm.toLowerCase())
            })["DealsPage[initialDeals.filter()]"];
            $[4] = searchTerm;
            $[5] = t2;
        } else {
            t2 = $[5];
        }
        const filteredDeals = initialDeals.filter(t2);
        let t3;
        ...
        if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
            t4 = ({
                "DealsPage[<input>.onChange]": (e)=>setSearchTerm(e.target.value)
            })["DealsPage[<input>.onChange]"];
            $[7] = t4;
        } else {
            t4 = $[7];
        }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        ...
                        filteredDeals.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: filteredDeals.map(_DealsPageFilteredDealsMap)
                        }, void 0, false, {
                            fileName: "[project]/components/DealsPage.tsx",
                            lineNumber: 60,
                            columnNumber: 171
                        }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "text-center py-20 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200",
...
_s(DealsPage, "+YdqPTpSlp4r5CWiFEQiF/UjThM=");
_c = DealsPage;
function _DealsPageFilteredDealsMap(deal_0) {
...
//# sourceMappingURL=_d09d20ee._.js.map