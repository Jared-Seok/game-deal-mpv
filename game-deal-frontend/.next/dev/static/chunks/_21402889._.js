...
const SaleDealCard = (t0)=>{
    ...
    if ($[0] !== "5d6e0c9f4cb84ab59ff3d1cda676a3728149c73d9eb61688455f4a4788b6bf81") {
        for(let $i = 0; $i < 43; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5d6e0c9f4cb84ab59ff3d1cda676a3728149c73d9eb61688455f4a4788b6bf81";
    }
    const { deal, className: t1 } = t0;
    const className = t1 === undefined ? "" : t1;
    const isSteam = deal.platform === "Steam";
    const formatEndDate = _temp;
    const getReviewText = _temp2;
    const t2 = `flex flex-col h-full bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:shadow-xl ${className}`;
    let t3;
    if ($[1] !== deal.image_url || $[2] !== deal.title) {
    ...
    let t7;
    if ($[11] !== deal.regular_price) {
        t7 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPrice"])(deal.regular_price);
        $[11] = deal.regular_price;
        $[12] = t7;
    } else {
        t7 = $[12];
    }
    ...
    let t9;
    if ($[15] !== deal.sale_price) {
        t9 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPrice"])(deal.sale_price);
        $[15] = deal.sale_price;
        $[16] = t9;
    } else {
        t9 = $[16];
    ...
    let t12;
    if ($[22] !== deal.steam_meta || $[23] !== isSteam) {
        t12 = isSteam && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t14;
    if ($[26] !== deal.end_date) {
        t14 = formatEndDate(deal.end_date);
        $[26] = deal.end_date;
        $[27] = t14;
    } else {
        t14 = $[27];
    ...
    let t16;
    if ($[30] !== deal.platform || $[31] !== deal.url) {
        t16 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mt-auto",
    ...
    let t17;
    if ($[33] !== t11 || $[34] !== t12 || $[35] !== t15 || $[36] !== t16 || $[37] !== t6) {
        t17 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function _temp2(meta) {
    if (!meta || meta.total_reviews === 0) {
        return "\uB9AC\uBDF0 \uC815\uBCF4 \uC5C6\uC74C";
    }
    return `${meta.positive_review_percent}% - ${meta.review_summary} (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPrice"])(meta.total_reviews)}개)`;
}
var _c;
...
function DealCard(t0) {
    ...
    if ($[0] !== "3e0a12c4ac8e61fd2e7b44fc5d262e3279f6c76f98fb92b93cec77dbecce71df") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3e0a12c4ac8e61fd2e7b44fc5d262e3279f6c76f98fb92b93cec77dbecce71df";
    }
    const { deal, className: t1 } = t0;
    const className = t1 === undefined ? "" : t1;
    const isFreeGame = deal.deal_type === "Free" || deal.sale_price === 0 && deal.deal_type !== "GamePass" || deal.epic_meta?.is_free_to_keep === true;
    if (isFreeGame) {
        let t2;
    ...
    const isGamePass = deal.deal_type === "GamePass" || deal.platform.includes("Xbox") || deal.xbox_meta !== undefined;
    if (isGamePass) {
        let t2;
...
//# sourceMappingURL=_21402889._.js.map